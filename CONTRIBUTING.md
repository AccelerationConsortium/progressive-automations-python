...
If you experience bugs or general issues with `progressive-automations-python`, please have a look
...
```
conda create -n progressive-automations-python python=3 six virtualenv pytest pytest-cov
conda activate progressive-automations-python
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/progressive-automations-python.git
...
5. Install [pre-commit]:
   ...
   `progressive-automations-python` comes with a lot of hooks configured to automatically help the
